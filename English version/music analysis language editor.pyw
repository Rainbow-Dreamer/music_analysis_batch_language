...
class Root(Tk):
    ...
    def __init__(self):
        ...
        self.inputs_text = ttk.Label(
            self,
            text='Please enter music analysis language',
            background=self.background_color)
        ...
        self.auto_box.place(x=530, y=0)
        self.grammar_box.place(x=650, y=0)
        self.wraplines_button.place(x=770, y=0)

        self.outputs_file_button = ttk.Button(
            self,
            text='Export music analysis contents',
            command=self.outputs_file)
        self.outputs_file_button.place(x=870, y=0)
        ...
        self.file_menu.add_command(label='Open',
                                   ...
                                   foreground=self.foreground_color)
        self.file_menu.add_command(label='Save codes',
                                   command=self.save_current_file,
                                   foreground=self.foreground_color)
        self.file_menu.add_command(label='Save export contents',
                                   command=self.outputs_file,
                                   foreground=self.foreground_color)
    ...
    def close_window(self):
        ...
        if current_text != self.last_save:
            ...
            self.ask_save_window.ask_save_label = ttk.Label(
                ...
                text='The file has changed, do you want to save?')
    ...
    def openfile(self):
        ...
        if filename:
            ...
            try:
                ...
                self.inputs.delete('1.0', END)
                self.inputs.insert(END, 'Invalid text file type')
    ...
    def config_options(self):
        ...
        self.config_window.search_text = ttk.Label(
            self.config_window, text='Search for config options')
        self.config_window.search_text.place(x=10, y=370)
    ...
    def runs(self):
        ...
        try:
            ...
            self.outputs.insert(END, 'Invalid code\n')
    ...
    def search_words(self):
        ...
        self.search_text = ttk.Label(
            self.search_box,
            text='Please enter the contents you want to search')
